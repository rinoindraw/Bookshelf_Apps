const List_Belum = "listBelum";
const List_Sudah = "listSudah";
...
function tambahBuku() {
    const listBelumBaca = document.getElementById(List_Belum);
    const listSudahBaca = document.getElementById(List_Sudah);
...
function tambahBukuSelesai(elemenBuku) {
    ...
    const listSelesai = document.getElementById(List_Sudah);
